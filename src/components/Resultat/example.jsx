...
const Mypdf = ({ nom_niveau,nom_mention,nom_parcour, children, session  }) => {
  return (
   <Document>
      <Page style={styles.body}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.text}>Niveau : {nom_niveau}</Text>
              </View>
        <View style={styles.row}>
          <Text style={styles.textFloat}> de Science sociale </Text>
          <Text style={styles.textFloat}>Mention : {nom_mention}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.textFloat}>de developpement</Text>
          <Text style={styles.text}>Parcours : {nom_parcour}</Text>
        </View>
        <View style={styles.row}>
            <Text style={styles.textFloat}>Formation :</Text>
          <Text style={styles.text}>Session :{ session}</Text>
        </View>
